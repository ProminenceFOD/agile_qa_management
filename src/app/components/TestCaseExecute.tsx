            ...
            <div className="p-6 space-y-6 max-h-[calc(100vh-16rem)] overflow-y-auto">
              {showSuccess ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-3xl text-gray-900 mb-3">Test Result Submitted!</h3>
                  <p className="text-lg text-gray-600 mb-2">
                    Test case <span className="font-medium text-indigo-600">{testCase.id}</span> completed with result:{' '}
                ...
                <>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      <h3 className="text-lg text-gray-800">Test Steps</h3>
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            {index === currentStep && !completedSteps[index] && (
                              <button
                                ...
                                className="px-4 py-2 bg-indigo-500 text-white rounded-lg hover:bg-indigo-600 transition-colors text-sm flex-shrink-0"
                              >
                                Complete
                              </button>
                            )}
                ...
                <>
                  <div className="text-center py-6">
                    ...
                    <h3 className="text-2xl text-gray-900 mb-2">All Steps Completed</h3>
                    <p className="text-gray-600">Please record the test result</p>
                  </div>
                  ...
                  {testResult === 'Fail' && onCreateBug && (
                    <div className="bg-red-50 border-2 border-red-200 rounded-lg p-4">
                      <div className="flex items-start gap-3">
                        <div className="flex-1">
                          <h4 className="text-sm font-medium text-red-900 mb-1">Test Failed - Create Bug Ticket</h4>
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors flex-shrink-0 flex items-center gap-2"
                        >
                          <span>🐛</span>
                    ...
                    {linkedBugs.length > 0 && (
                      <div className="flex flex-wrap gap-2 mb-3">
                        {linkedBugs.map(bugId => {
                          ...
                          return (
                            <div key={bugId} className="flex items-center gap-2 px-3 py-2 bg-red-100 text-red-800 rounded-lg border border-red-200">
                              <div>
                                <span className="text-sm font-medium">{bugId}</span>
                                {bug && (
                                  <div className="text-xs text-red-700">{bug.title}</div>
                                )}
                              </div>
                              <button
                    ...
                    <div className="flex gap-2">
                      <div className="relative flex-1">
                        <button
                          ...
                          className="w-full px-4 py-2 bg-white border-2 border-gray-300 text-gray-700 rounded-lg hover:border-indigo-500 transition-colors flex items-center justify-between"
                        >
                          <span>Select Existing Bug</span>
                          <span className="text-xs">{availableBugs.length} available</span>
                        </button>
                                ...
                                >
                                  <div className="flex items-start justify-between">
                                    <div className="flex-1">
                                      ...
                                      <div className="text-sm text-gray-600 mt-1">{bug.title}</div>
