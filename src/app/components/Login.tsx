  ...
  return (
    ...
    >
      ...
      <div className="w-full xs:w-8/12 md:w-7/12 xs:bg-[#f9fafa] flex items-center justify-center p-4 sm:p-6 md:p-12 overflow-y-auto relative z-10">
        <div className="w-full max-w-md bg-white p-6 sm:p-8 rounded-2xl shadow-2xl border border-gray-100 xs:border-none xs:shadow-none xs:p-0 xs:bg-transparent">
          <div className="mb-8">
