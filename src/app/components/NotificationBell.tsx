...
export function NotificationBell({ notifications, onMarkAsRead, onMarkAllAsRead, onClearAll }: NotificationBellProps) {
  ...
  const getTypeColor = (type: Notification['type']) => {
    switch (type) {
      case 'assignment': return 'bg-indigo-50 border-indigo-200';
                  ...
                  {notifications.map((notification) => (
                    ...
                    >
                      <div className="flex gap-3">
                        <div className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center text-lg border ${getTypeColor(notification.type)}`}>
